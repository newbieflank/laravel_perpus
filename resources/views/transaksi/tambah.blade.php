                            ...
                            <div class="border-b border-gray-900/10 pb-12">
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="pengarang" class="block mt-1 w-full" type="text"
                                        name="pengarang" :value="old('pengarang')" required autofocus autocomplete="off" />
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="mt-2">
                                        <textarea name="deskripsi" id="deskripsi" rows="3"
                                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 dark:placeholder:text-gray-100 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6 dark:bg-gray-800 dark:text-gray-100"></textarea>
                                    </div>
                                    <p class="mt-3 text-sm/6 text-gray-600">Write a few sentences about the book</p>
                                </div>
